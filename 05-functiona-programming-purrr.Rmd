...
em cada elemento da entrada e devem retornar `TRUE` ou `FALSE`).
...
Com a utilização de fórmulas poderíamos eliminar completamente a necessidade de funções declaradas:
